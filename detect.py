...
@torch.no_grad()
def run(weights=ROOT / './runs/train/yolov5l_results4/weights/best.pt',  # model.pt path(s)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runs/train/yolov5l_results4/weights/best.pt', help='model path(s)')
